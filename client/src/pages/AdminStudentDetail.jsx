                ...
                <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-[0_4px_20px_-2px_rgba(0,0,0,0.1)] dark:shadow-black/40 border border-transparent dark:border-slate-800 overflow-hidden">
                    ...
                    <div className="p-6 md:p-8">
                        ...
                        <div className="space-y-4">
                             ...
                             <div className="mt-6">
                                <div className="flex items-center gap-2 mb-2">
                                    <span className="text-xs font-semibold uppercase text-slate-400 tracking-wider">Pembayaran Pendidikan</span>
                                    <div className="h-px bg-slate-200 dark:bg-slate-700 flex-1"></div>
                                </div>

                                <div className="rounded-2xl bg-slate-50 dark:bg-slate-800/60 p-4 shadow-sm">
                                    <div className="flex items-start justify-between gap-3">
                                        ...
                                        {docs?.payment_proof_path ? (
                                            <a
                                                href={toFileUrl(docs.payment_proof_path)}
                                                target="_blank"
                                                rel="noreferrer"
                                                className="shrink-0 inline-flex items-center gap-2 rounded-xl bg-slate-900 dark:bg-slate-950 text-white px-3 py-2 text-xs font-bold hover:bg-indigo-600 transition"
                                            >
                                                <Eye size={16} />
                                                Lihat Bukti
                                            </a>
                                        ) : (
                                            <span className="shrink-0 inline-flex items-center gap-2 rounded-xl bg-white/80 dark:bg-slate-900 text-slate-500 dark:text-slate-400 px-3 py-2 text-xs font-bold border border-slate-200 dark:border-slate-700">
                                                <Eye size={16} />
                                                Tidak Ada
                                            </span>
                                        )}
                                    ...
                                    <div className="mt-3 flex flex-col sm:flex-row gap-2 sm:items-center">
                                        <select
                                            ...
                                            className="h-11 w-full sm:w-auto rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 px-3 text-sm font-bold text-slate-800 dark:text-slate-100 disabled:opacity-60"
                                        >
                                        ...
                                        <button
                                            ...
                                            disabled={!canEditPayment || isUpdatingPayment}
                                            className="h-11 w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 text-white px-4 text-sm font-extrabold hover:bg-indigo-700 disabled:opacity-60 disabled:hover:bg-indigo-600 transition"
                                        >
                                            <Save size={18} />
                                            Simpan Status
                                        </button>
