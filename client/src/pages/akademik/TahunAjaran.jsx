  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        <PageHeader
          title="Tahun Ajaran"
          description="Halaman ini akan digunakan untuk mengelola tahun ajaran."
          breadcrumbs={[{ label: 'Dashboard' }, { label: 'Akademik' }, { label: 'Pengaturan Akademik' }, { label: 'Tahun Ajaran' }]}
        />
